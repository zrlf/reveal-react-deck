...
export const Admonition = (props: {
  ...
  return (
    <div className={cn("admonition", "admonition-" + type, className)}>
      {!hideTitle && (
      ...
      <div className={cn("admonition-content", props.contentClasses)}>
        {children}
      </div>
    </div>
  );
...
export const Box = (props) => {
  ...
  return (
    <div className={cn("admonition", bgColor)}>
...
const svgMap = {
  ...
  paper: (
    ...
    >
      <path
        d="M11.5,9.5C11.5,9.224,11.724,9,12,9h5c0.276,0,0.5,0.224,0.5,0.5S17.276,10,17,10h-5
